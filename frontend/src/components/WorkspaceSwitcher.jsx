import { Layers, CheckCircle2, PanelRightClose, CalendarDays, BookOpen } from 'lucide-react'
                    ...
                    <div className="flex items-center gap-3 mt-2 text-xs text-slate-500">
                      ...
                      {ws.updated && (
                        <span className="inline-flex items-center gap-1">
                          ...
                          {new Date(ws.updated).toLocaleDateString()}
                        </span>
                      )}
                    </div>
                  </div>
                  {isActive && <CheckCircle2 size={16} className="text-emerald-600 ml-2 mt-0.5 flex-shrink-0" />}
                </div>
              </button>
            )
          })
