...
- **vision.py** — Visual inspection tools. `see_page` returns page imagery for direct inspection, and `highlight_on_page` generates Gemini highlight layers for workspace pages.
